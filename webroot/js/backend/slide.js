{
    ...
    tinyMCE.init({
        ...
        plugins: [
            'advlist', 'autolink', 'link', 'lists', 'code', 'fullscreen', 'wordcount'
        ],
        toolbar: 'undo redo | fontsize | bold italic underline removeformat | forecolor backcolor | align bullist numlist | link | code | fullscreen',
